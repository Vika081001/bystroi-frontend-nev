import { ListResponse, ListParams } from "./api";
...
export type CreateReview = Pick<Review, "entity_type" | "entity_id" | "text"> & { contragent_phone: string }
export type UpdateReview = { id: number, rating: 5, text: string, contragent_phone: string }